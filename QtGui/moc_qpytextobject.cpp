...
#include "../qpy/QtGui/qpytextobject.h"
...
struct qt_meta_stringdata_QPyTextObject_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPyTextObject_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QPyTextObject_t qt_meta_stringdata_QPyTextObject = {
    {
QT_MOC_LITERAL(0, 0, 13) // "QPyTextObject"
...
const QMetaObject QPyTextObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPyTextObject.data,
      qt_meta_data_QPyTextObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPyTextObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPyTextObject.stringdata0))
