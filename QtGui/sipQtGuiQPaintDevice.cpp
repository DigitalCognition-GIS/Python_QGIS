...
#line 34 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtGui/sipQtGuiQPaintDevice.cpp"

#line 61 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/sip/QtGui/qpaintengine.sip"
#include <qpaintengine.h>
#line 38 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtGui/sipQtGuiQPaintDevice.cpp"
...
static sipEnumMemberDef enummembers_QPaintDevice[] = {
    {sipName_PdmDepth, static_cast<int>(QPaintDevice::PdmDepth), 364},
    {sipName_PdmDpiX, static_cast<int>(QPaintDevice::PdmDpiX), 364},
    {sipName_PdmDpiY, static_cast<int>(QPaintDevice::PdmDpiY), 364},
    {sipName_PdmHeight, static_cast<int>(QPaintDevice::PdmHeight), 364},
    {sipName_PdmHeightMM, static_cast<int>(QPaintDevice::PdmHeightMM), 364},
    {sipName_PdmNumColors, static_cast<int>(QPaintDevice::PdmNumColors), 364},
    {sipName_PdmPhysicalDpiX, static_cast<int>(QPaintDevice::PdmPhysicalDpiX), 364},
    {sipName_PdmPhysicalDpiY, static_cast<int>(QPaintDevice::PdmPhysicalDpiY), 364},
    {sipName_PdmWidth, static_cast<int>(QPaintDevice::PdmWidth), 364},
    {sipName_PdmWidthMM, static_cast<int>(QPaintDevice::PdmWidthMM), 364},
};
