...
#include <qtextobject.h>
#line 36 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtGui/sipQtGuiQTextBlockiterator.cpp"

#line 257 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/sip/QtGui/qtextobject.sip"
#include <qtextobject.h>
#line 40 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtGui/sipQtGuiQTextBlockiterator.cpp"
...
static PyObject *slot_QTextBlock_iterator___isub__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        {
#line 181 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)--;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)++;
#line 131 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtGui/sipQtGuiQTextBlockiterator.cpp"
...
static PyObject *slot_QTextBlock_iterator___iadd__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1i", &a0))
        {
#line 171 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)++;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)--;
#line 178 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtGui/sipQtGuiQTextBlockiterator.cpp"
