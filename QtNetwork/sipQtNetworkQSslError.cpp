...
#include <qsslerror.h>
#line 34 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtNetwork/sipQtNetworkQSslError.cpp"

#line 34 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/sip/QtNetwork/qsslcertificate.sip"
#include <qsslcertificate.h>
#line 38 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtNetwork/sipQtNetworkQSslError.cpp"
#line 36 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 41 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtNetwork/sipQtNetworkQSslError.cpp"
...
PyDoc_STRVAR(doc_QSslError_errorString, "errorString(self) -> QString");
...
static sipEnumMemberDef enummembers_QSslError[] = {
    {sipName_AuthorityIssuerSerialNumberMismatch, static_cast<int>(QSslError::AuthorityIssuerSerialNumberMismatch), 107},
    {sipName_CertificateBlacklisted, static_cast<int>(QSslError::CertificateBlacklisted), 107},
    {sipName_CertificateExpired, static_cast<int>(QSslError::CertificateExpired), 107},
    {sipName_CertificateNotYetValid, static_cast<int>(QSslError::CertificateNotYetValid), 107},
    {sipName_CertificateRejected, static_cast<int>(QSslError::CertificateRejected), 107},
    {sipName_CertificateRevoked, static_cast<int>(QSslError::CertificateRevoked), 107},
    {sipName_CertificateSignatureFailed, static_cast<int>(QSslError::CertificateSignatureFailed), 107},
    {sipName_CertificateUntrusted, static_cast<int>(QSslError::CertificateUntrusted), 107},
    {sipName_HostNameMismatch, static_cast<int>(QSslError::HostNameMismatch), 107},
    {sipName_InvalidCaCertificate, static_cast<int>(QSslError::InvalidCaCertificate), 107},
    {sipName_InvalidNotAfterField, static_cast<int>(QSslError::InvalidNotAfterField), 107},
    {sipName_InvalidNotBeforeField, static_cast<int>(QSslError::InvalidNotBeforeField), 107},
    {sipName_InvalidPurpose, static_cast<int>(QSslError::InvalidPurpose), 107},
    {sipName_NoError, static_cast<int>(QSslError::NoError), 107},
    {sipName_NoPeerCertificate, static_cast<int>(QSslError::NoPeerCertificate), 107},
    {sipName_NoSslSupport, static_cast<int>(QSslError::NoSslSupport), 107},
    {sipName_PathLengthExceeded, static_cast<int>(QSslError::PathLengthExceeded), 107},
    {sipName_SelfSignedCertificate, static_cast<int>(QSslError::SelfSignedCertificate), 107},
    {sipName_SelfSignedCertificateInChain, static_cast<int>(QSslError::SelfSignedCertificateInChain), 107},
    {sipName_SubjectIssuerMismatch, static_cast<int>(QSslError::SubjectIssuerMismatch), 107},
    {sipName_UnableToDecodeIssuerPublicKey, static_cast<int>(QSslError::UnableToDecodeIssuerPublicKey), 107},
    {sipName_UnableToDecryptCertificateSignature, static_cast<int>(QSslError::UnableToDecryptCertificateSignature), 107},
    {sipName_UnableToGetIssuerCertificate, static_cast<int>(QSslError::UnableToGetIssuerCertificate), 107},
    {sipName_UnableToGetLocalIssuerCertificate, static_cast<int>(QSslError::UnableToGetLocalIssuerCertificate), 107},
    {sipName_UnableToVerifyFirstCertificate, static_cast<int>(QSslError::UnableToVerifyFirstCertificate), 107},
    {sipName_UnspecifiedError, static_cast<int>(QSslError::UnspecifiedError), 107},
};
