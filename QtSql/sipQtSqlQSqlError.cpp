...
#include <qsqlerror.h>
#line 34 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtSql/sipQtSqlQSqlError.cpp"

#line 36 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 38 "/media/dhankar/Dhankar_1/a1_18/a1_______QGIS/QtSql/sipQtSqlQSqlError.cpp"


PyDoc_STRVAR(doc_QSqlError_driverText, "driverText(self) -> QString");
...
PyDoc_STRVAR(doc_QSqlError_setDriverText, "setDriverText(self, QString)");
...
PyDoc_STRVAR(doc_QSqlError_databaseText, "databaseText(self) -> QString");
...
PyDoc_STRVAR(doc_QSqlError_setDatabaseText, "setDatabaseText(self, QString)");
...
PyDoc_STRVAR(doc_QSqlError_text, "text(self) -> QString");
...
PyDoc_STRVAR(doc_QSqlError, "\1QSqlError(driverText: QString = QString(), databaseText: QString = QString(), type: QSqlError.ErrorType = QSqlError.NoError, number: int = -1)\n"
    "QSqlError(QSqlError)");
