...
#    'QtGui':            ModuleMetadata(qmake_QT=['widgets', 'printsupport'], qpy_lib=True),

    'QtGui':            ModuleMetadata(qmake_QT=['widgets'], qpy_lib=True),

## Dhankar FART CHanged above line basis -- https://stackoverflow.com/questions/26560673/issues-building-pyqt5-for-python3-4-in-ubuntu-14-04-caused-by-qprinter-h-not-fou
